  ...
  const statusIcons = {
    ...
    'dead': `
      <span class="status-icon status-dead" title="Link is dead or unreachable">
        <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24">
          <path d="M10.59,13.41C11,13.8 11,14.44 11,15C11,15.55 10.78,16.05 10.41,16.41L9,17.83C8.62,18.21 8.12,18.43 7.57,18.43C7,18.43 6.5,18.21 6.12,17.83L4.7,16.41C4.32,16.05 4.1,15.55 4.1,15C4.1,14.44 4.32,13.94 4.7,13.58L6.12,12.16C6.5,11.78 7,11.56 7.57,11.56C8.12,11.56 8.62,11.78 9,12.16M7.57,10C6.5,10 5.5,10.39 4.76,11.12L3.34,12.54C2.6,13.28 2.22,14.28 2.22,15.34C2.22,16.39 2.6,17.39 3.34,18.12L4.76,19.54C5.5,20.28 6.5,20.66 7.57,20.66C8.62,20.66 9.62,20.28 10.36,19.54L11.78,18.12C12.52,17.39 12.9,16.39 12.9,15.34C12.9,14.28 12.52,13.28 11.78,12.54L10.36,11.12C9.62,10.39 8.62,10 7.57,10M16.43,4C15.38,4 14.38,4.39 13.64,5.12L12.22,6.54L13.64,7.96L15.06,6.54C15.44,6.17 15.94,5.95 16.5,5.95C17.05,5.95 17.55,6.17 17.93,6.54L19.35,7.96C19.73,8.33 19.95,8.83 19.95,9.39C19.95,9.94 19.73,10.44 19.35,10.81L17.93,12.23C17.55,12.61 17.05,12.83 16.5,12.83C15.94,12.83 15.44,12.61 15.06,12.23L13.64,10.81L12.22,12.23C12.96,12.97 13.96,13.35 15,13.35C16.05,13.35 17.05,12.97 17.79,12.23L19.21,10.81C19.95,10.08 20.33,9.08 20.33,8.03C20.33,6.97 19.95,5.97 19.21,5.24L17.79,3.82C17.05,3.08 16.05,2.7 15,2.7C14.95,2.7 14.9,2.7 14.86,2.7C14.95,3.08 15,3.54 15.43,4"/>
        </svg>
      </span>
    `,
    'parked': `
